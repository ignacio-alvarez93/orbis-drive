...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "ID_RESOLUTION para T_Localidades."
        )
    )
...
def default_report_path(csv_path: Path) -> Path:
    return Path("data/samples/output") / f"{csv_path.stem}__id_resolution_localidades_report.json"
...
def print_summary(payload: dict[str, Any]) -> None:
    ...
    if idr["is_valid_batch"]:
        print("[OK] ID_RESOLUTION de localidades completada: lote persistible.")
    else:
        print("[WARN] ID_RESOLUTION de localidades detectó incidencias.")
